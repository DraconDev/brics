...
/// A "Cheaty" list that automatically stacks items with a default gap.
/// Useful for menus, sidebars, or simple lists without thinking about Flexbox.
#[derive(Bundle, Clone, Debug)]
pub struct AutoList {
    pub node: Node,
    pub visibility: Visibility,
    ...
    fn default() -> Self {
        Self {
            node: Node {
                ...
                flex_direction: FlexDirection::Column,
                align_items: AlignItems::Start,
                row_gap: Val::Px(10.0), // Default "Cheaty" gap
                ..default()
            },
            visibility: default(),
            inherited_visibility: default(),
